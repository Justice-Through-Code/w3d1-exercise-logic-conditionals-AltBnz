...
def snippet_4():
    ...
    # d will evaluate to False by using the 'and' logical operator, which requires that both expressions be true.
    # d evaluates to False because while 5 is less than 7, 8 is not greater than 20.
